    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 md:mx-auto md:w-full md:max-w-md">
        ...
        <div class="p-5 bg-white rounded-md shadow-md">
                <form action="">
                    ...
                    <button @click.prevent="selectLocation" type="submit" class="mt-4 py-2 px-4 float-right bg-black text-yellow-50 text-sm font-medium rounded-md">Find a ride</button>
                </form>
        </div>
    </div>
</template>
